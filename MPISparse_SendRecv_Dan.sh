...
## to job id.
#SBATCH --job-name MPISparse_SendRecv_Dan
...
## of output)
#SBATCH --error=MPISparse_SendRecv_Dan.err
#SBATCH	--output=MPISparse_SendRecv_Dan.out
...
mpiexec ~/Assignments/Homework/Final\ Project/MPISparse_SendRecv_Dan
